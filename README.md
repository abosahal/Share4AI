...
**[تنزيل مثبت Windows مباشرة](https://github.com/abosahal/Share4AI/releases/download/windows-preview-18-1/Share4AI-Setup-1.1.4-windows-x64.exe)** — نسخة تجريبية، نحو 11 MB. افتح الملف واضغط تثبيت؛ لا تحتاج الطرفية أو Python. المثبت غير موقع رقميًا بعد، وقد يعرض Windows تحذير ناشر غير معروف.
...
1. نزّل ملف **Share4AI-Setup-1.1.4-windows-x64.exe** المرفق بالنسخة التجريبية وافتحه ثم اضغط **تثبيت**. يتضمن متطلبات التشغيل؛ لا تحتاج Python أو الطرفية.
...
**[Download the Windows installer directly](https://github.com/abosahal/Share4AI/releases/download/windows-preview-18-1/Share4AI-Setup-1.1.4-windows-x64.exe)** — trial build, about 11 MB. Open the file and select Install; no terminal or Python is required. The installer is not digitally signed yet and Windows may display an unknown-publisher warning.
...
1. Download **Share4AI-Setup-1.1.4-windows-x64.exe** attached to the trial build, open it and select **Install**. Runtime requirements are bundled; no Python or terminal is needed.

...
def launch(state_dir=None):
    ...
    ttk.Label(window, text='Windows alpha • Local AI first • Network job execution comes in Sprint 2').pack(anchor='w', padx=18)
    ...
    ttk.Label(setup, text='This alpha registers your device and sends health updates. It does not accept customer jobs.', wraplength=800).pack(anchor='w')

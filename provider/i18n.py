...
TEXT.update({
    ...
    'Device report': 'تقرير الجهاز',
    'Graphics card': 'بطاقة الرسوميات',
    'GPU memory': 'ذاكرة الرسوميات',
    'Free GPU memory': 'ذاكرة الرسوميات المتاحة',
    'GPU usage now': 'استخدام الرسوميات الآن',
    'GPU temperature': 'حرارة الرسوميات',
    'Processor': 'المعالج',
    'Recommended model': 'النموذج الموصى به',
    'Device notes': 'ملاحظات الجهاز',
    'Copy device report': 'نسخ تقرير الجهاز',
    'Device report copied': 'تم نسخ تقرير الجهاز',
    'Could not copy device report': 'تعذر نسخ تقرير الجهاز',
    'Device does not meet this version': 'الجهاز لا يلبي متطلبات هذه النسخة',
    'CPU local trial only': 'تجربة محلية على المعالج فقط',
    'Ready with partial GPU offload': 'جاهز مع إفراغ جزئي إلى الرام',
    'Ready for GPU Local AI': 'جاهز للذكاء المحلي على الرسوميات',
    'CPU': 'المعالج',
    'GPU offload': 'إفراغ إلى الرام',
    'GPU': 'الرسوميات',
    'This computer': 'هذا الجهاز',
    'Next action': 'الإجراء التالي',
    'Model download': 'تنزيل النموذج',
    'Qwen3.8 27B: 15.3 GB plus runtime': 'Qwen3.8 27B: 15.3 GB بالإضافة إلى المحرك',
})

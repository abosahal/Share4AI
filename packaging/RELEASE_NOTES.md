...
نزّل ملف Share4AI-Setup-1.1.1-windows-x64.exe وافتحه ثم اضغط تثبيت. بعد الانتهاء افتح Share4AI من الاختصار. لا تحتاج Python أو الطرفية. يختار التطبيق نموذجًا مناسبًا وينزله بعد موافقتك.
...
Download Share4AI-Setup-1.1.1-windows-x64.exe, open it and select Install. Then open Share4AI from its shortcut. No Python or terminal is required. The app selects a suitable model and downloads it after your confirmation.
